FROM alpine:3.13
LABEL maintainer="Heru Rahmat Akhnuari <eyubalzary@gmail.com>" \
      description="Lumen, or Laravel image with Nginx 1.18, PHP-FPM 8, Mongo, Composer 2, and Supercronic (Cron) based on Alpine Linux."
